...
description = "Displays Health, Hunger, Sanity, Temperature, Seasons, Moon Phase, World Day, and Doydoys."

--Who wrote this awesome mod?
author = "Gymmed, rezecib, Kiopho, Soilworker, hotmatrixx, penguin0616"
...
configuration_options =
{
	...
	},	
	{
		...
		{
		name = "SHOWDOYDOYS",
		label = "Doydoy population",
		hover = "Shows how many doydoys there are in that world.\nDoes not work in Don't Starve Together.",
		options =	{
						{description = "Show", data = true},
						{description = "Hide", data = false},
					},
